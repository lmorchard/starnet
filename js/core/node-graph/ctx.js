...
export const nullCtx = {
  ...
  resolveLoot(_nodeId) {},
  resolveMine(_nodeId) {},
  resolveSniff(_nodeId) {},
  resolveReplay(_nodeId) {},
...
export function mockCtx() {
  ...
  const ctx = {
    ...
    scrubLogs: spy("scrubLogs"),
    lieLow: spy("lieLow"),
    recordHeat: spy("recordHeat"),
    ...
    abortTimedAction: spy("abortTimedAction"),
    abortNode: spy("abortNode"),
    ...
    resolveMine: spy("resolveMine"),
    resolveSniff: spy("resolveSniff"),
    resolveReplay: spy("resolveReplay"),
