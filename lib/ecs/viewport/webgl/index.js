...
WebGLDrawParameters.schema = {
  ...
  afterGlow: { type: Types.Number, default: 0.1 },
};
...
export function draw(worldState, interpolationPercentage) {
  ...
  drawProps.afterGlow = webglDrawParameters.afterGlow;
  Object.assign(layerDrawProps.world, camera, webglDrawParameters);
  Object.assign(layerDrawProps.backdrop, camera);
  worldState.getMutableComponent(WebGLContext).webglDraw.draw(layerDrawProps, drawProps);
}
